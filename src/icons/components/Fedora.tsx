  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={29.21}
      />
      <use transform="rotate(180 124.856 142.144)" xlinkHref="#prefix__a" />
      <path
        d="M139.607 127.53v62.345c0 34.504-27.975 62.48-62.48 62.48-5.235 0-8.957-.59-13.803-1.857-7.066-1.85-12.84-7.643-12.842-14.381 0-8.146 5.912-14.07 14.75-14.07 4.206 0 5.733.807 11.895.807 18.191 0 32.947-14.735 32.98-32.926V161.27a4.654 4.654 0 00-4.66-4.648l-21.665-.005c-8.072 0-14.594-6.438-14.594-14.532-.004-8.145 6.59-14.557 14.749-14.557"
        id="prefix__b"
        fill="#fff"
      />
      <use transform="rotate(180 124.856 142.144)" xlinkHref="#prefix__b" />
      <path
        d="M243.655 243.584v-5.531l-2.529 5.798-2.461-5.798v5.531h-1.418v-8.735h1.487l2.434 5.58 2.397-5.58h1.505v8.735h-1.415zm-10.333-7.272v7.272h-1.483v-7.272h-2.484v-1.463h6.449v1.463"
        fill="#3c6eb4"
      />
    </svg>
  );
